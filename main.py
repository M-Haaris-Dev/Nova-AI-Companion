...
COMMAND_MAP={"open notepad":{"type":"app","target":"notepad.exe","response":"Notepad's ready for you!","emotion":"happy"},"open calculator":{"type":"app","target":"calc.exe","response":"Calculator coming right up!","emotion":"curious"},"open paint":{"type":"app","target":"mspaint.exe","response":"Paint time! Get creative!","emotion":"excited"},"open cmd":{"type":"app","target":"cmd.exe","response":"Command Prompt ready!","emotion":"proud"},"open powershell":{"type":"app","target":"powershell.exe","response":"PowerShell activated!","emotion":"determined"},"open terminal":{"type":"app","target":"wt.exe","response":"Terminal ready to go!","emotion":"proud"},"open explorer":{"type":"app","target":"explorer.exe","response":"File Explorer opening!","emotion":"curious"},"open task manager":{"type":"app","target":"taskmgr.exe","response":"Task Manager opened! Everything okay?","emotion":"worried"},"open settings":{"type":"system","target":"ms-settings:","response":"Settings panel open!","emotion":"watching"},"open control panel":{"type":"app","target":"control.exe","response":"Control Panel ready!","emotion":"watching"},"open snipping tool":{"type":"app","target":"snippingtool.exe","response":"Screenshot tool ready!","emotion":"happy"},"open word":{"type":"app","target":"winword.exe","response":"Microsoft Word is up!","emotion":"watching"},"open excel":{"type":"app","target":"excel.exe","response":"Excel ready! Let's crunch numbers!","emotion":"determined"},"open powerpoint":{"type":"app","target":"powerpnt.exe","response":"PowerPoint loaded!","emotion":"excited"},"open outlook":{"type":"app","target":"outlook.exe","response":"Checking emails!","emotion":"watching"},"open onenote":{"type":"app","target":"onenote.exe","response":"OneNote ready for notes!","emotion":"happy"},"open teams":{"type":"system","target":"ms-teams:","response":"Teams is up! Meeting time?","emotion":"watching"},"open chrome":{"type":"app","target":"chrome.exe","response":"Chrome browser opening!","emotion":"curious"},"open firefox":{"type":"app","target":"firefox.exe","response":"Firefox ready!","emotion":"proud"},"open edge":{"type":"app","target":"msedge.exe","response":"Edge browser opening!","emotion":"watching"},"open brave":{"type":"app","target":"brave.exe","response":"Brave browser! Nice choice!","emotion":"proud"},"open opera":{"type":"app","target":"opera.exe","response":"Opera browser ready!","emotion":"happy"},"open vscode":{"type":"app","target":"code","response":"VS Code ready! Let's build something!","emotion":"excited"},"open visual studio":{"type":"app","target":"devenv.exe","response":"Visual Studio loading! Time to build!","emotion":"excited"},"open youtube":{"type":"web","target":"https://www.youtube.com","response":"Opening YouTube!","emotion":"happy"},"open yt":{"type":"web","target":"https://www.youtube.com","response":"Opening YouTube!","emotion":"happy"},"open google":{"type":"web","target":"https://www.google.com","response":"Google search ready!","emotion":"curious"},"open github":{"type":"web","target":"https://www.github.com","response":"GitHub opening!","emotion":"proud"},"open gmail":{"type":"web","target":"https://mail.google.com","response":"Gmail opening!","emotion":"watching"},"open google drive":{"type":"web","target":"https://drive.google.com","response":"Google Drive ready!","emotion":"happy"},"open google docs":{"type":"web","target":"https://docs.google.com","response":"Google Docs opening!","emotion":"watching"},"open google sheets":{"type":"web","target":"https://sheets.google.com","response":"Google Sheets ready!","emotion":"watching"},"open google slides":{"type":"web","target":"https://slides.google.com","response":"Google Slides opening!","emotion":"watching"},"open google colab":{"type":"web","target":"https://colab.research.google.com","response":"Google Colab ready! Free GPU time!","emotion":"excited"},"open colab":{"type":"web","target":"https://colab.research.google.com","response":"Google Colab ready!","emotion":"excited"},"open reddit":{"type":"web","target":"https://www.reddit.com","response":"Reddit opening! Don't get lost!","emotion":"playful"},"open twitter":{"type":"web","target":"https://www.twitter.com","response":"Twitter X opening!","emotion":"curious"},"open instagram":{"type":"web","target":"https://www.instagram.com","response":"Instagram opening!","emotion":"happy"},"open ig":{"type":"web","target":"https://www.instagram.com","response":"Instagram opening!","emotion":"happy"},"open facebook":{"type":"web","target":"https://www.facebook.com","response":"Facebook opening!","emotion":"happy"},"open fb":{"type":"web","target":"https://www.facebook.com","response":"Facebook opening!","emotion":"happy"},"open linkedin":{"type":"web","target":"https://www.linkedin.com","response":"LinkedIn opening! Professional mode!","emotion":"proud"},"open whatsapp":{"type":"web","target":"https://web.whatsapp.com","response":"WhatsApp opening!","emotion":"happy"},"open telegram":{"type":"web","target":"https://web.telegram.org","response":"Telegram opening!","emotion":"proud"},"open netflix":{"type":"web","target":"https://www.netflix.com","response":"Netflix time! Enjoy!","emotion":"excited"},"open amazon":{"type":"web","target":"https://www.amazon.com","response":"Amazon opening!","emotion":"curious"},"open wikipedia":{"type":"web","target":"https://www.wikipedia.org","response":"Wikipedia! Knowledge time!","emotion":"curious"},"open stackoverflow":{"type":"web","target":"https://stackoverflow.com","response":"StackOverflow ready!","emotion":"proud"},"open w3schools":{"type":"web","target":"https://www.w3schools.com","response":"W3Schools opening!","emotion":"happy"},"open coursera":{"type":"web","target":"https://www.coursera.org","response":"Coursera! Great choice!","emotion":"proud"},"open udemy":{"type":"web","target":"https://www.udemy.com","response":"Udemy opening!","emotion":"excited"},"open khan academy":{"type":"web","target":"https://www.khanacademy.org","response":"Khan Academy! Smart move!","emotion":"proud"},"open leetcode":{"type":"web","target":"https://leetcode.com","response":"LeetCode! Time to sharpen that blade!","emotion":"determined"},"open neetcode":{"type":"web","target":"https://neetcode.io","response":"NeetCode roadmap! Strategic training!","emotion":"proud"},"open hackerrank":{"type":"web","target":"https://www.hackerrank.com","response":"HackerRank opening! Challenge accepted!","emotion":"excited"},"open codeforces":{"type":"web","target":"https://codeforces.com","response":"Codeforces! Competitive mode ON!","emotion":"determined"},"open codechef":{"type":"web","target":"https://www.codechef.com","response":"CodeChef ready!","emotion":"excited"},"open geeksforgeeks":{"type":"web","target":"https://www.geeksforgeeks.org","response":"GeeksforGeeks opening!","emotion":"proud"},"open gfg":{"type":"web","target":"https://www.geeksforgeeks.org","response":"GeeksforGeeks opening!","emotion":"proud"},"open chatgpt":{"type":"web","target":"https://chat.openai.com","response":"ChatGPT opening! But hey, I'm right here!","emotion":"playful"},"open claude":{"type":"web","target":"https://claude.ai","response":"Claude opening! Two AI brains are better than one!","emotion":"playful"},"open gemini":{"type":"web","target":"https://gemini.google.com","response":"Gemini opening! That's my brain right there!","emotion":"proud"},"open perplexity":{"type":"web","target":"https://www.perplexity.ai","response":"Perplexity AI opening!","emotion":"curious"},"open canva":{"type":"web","target":"https://www.canva.com","response":"Canva design time!","emotion":"excited"},"open figma":{"type":"web","target":"https://www.figma.com","response":"Figma ready!","emotion":"excited"},"open notion":{"type":"web","target":"https://www.notion.so","response":"Notion opening! Stay organized!","emotion":"determined"},"open twitch":{"type":"web","target":"https://www.twitch.tv","response":"Twitch opening!","emotion":"excited"},"open pinterest":{"type":"web","target":"https://www.pinterest.com","response":"Pinterest opening!","emotion":"happy"},"open tiktok":{"type":"web","target":"https://www.tiktok.com","response":"TikTok! Watch the time though!","emotion":"playful"},"open ebay":{"type":"web","target":"https://www.ebay.com","response":"eBay opening!","emotion":"curious"},"open zoom":{"type":"web","target":"https://zoom.us","response":"Zoom ready!","emotion":"watching"},"open slack":{"type":"web","target":"https://slack.com","response":"Slack opening!","emotion":"watching"},"open spotify":{"type":"web","target":"https://open.spotify.com","response":"Spotify! Enjoy the music!","emotion":"happy"},"open steam":{"type":"system","target":"steam://open/main","response":"Steam opening! Game time!","emotion":"excited"},"open replit":{"type":"web","target":"https://replit.com","response":"Replit ready! Code anywhere!","emotion":"excited"},"open kaggle":{"type":"web","target":"https://www.kaggle.com","response":"Kaggle opening! Data science time!","emotion":"proud"},"open huggingface":{"type":"web","target":"https://huggingface.co","response":"HuggingFace! AI models galore!","emotion":"excited"},"open vercel":{"type":"web","target":"https://vercel.com","response":"Vercel opening! Deploy time!","emotion":"proud"},"open netlify":{"type":"web","target":"https://www.netlify.com","response":"Netlify ready!","emotion":"proud"},"open render":{"type":"web","target":"https://render.com","response":"Render opening!","emotion":"happy"},"open medium":{"type":"web","target":"https://medium.com","response":"Medium! Knowledge is power!","emotion":"curious"},"open devto":{"type":"web","target":"https://dev.to","response":"Dev.to opening! Community time!","emotion":"happy"},"open hashnode":{"type":"web","target":"https://hashnode.com","response":"Hashnode ready!","emotion":"proud"},"open codepen":{"type":"web","target":"https://codepen.io","response":"CodePen opening! Creative coding!","emotion":"excited"},"open jsfiddle":{"type":"web","target":"https://jsfiddle.net","response":"JSFiddle ready!","emotion":"happy"},"open npmjs":{"type":"web","target":"https://www.npmjs.com","response":"NPM registry opening!","emotion":"watching"},"open pypi":{"type":"web","target":"https://pypi.org","response":"PyPI opening! Python packages!","emotion":"proud"},"open docker hub":{"type":"web","target":"https://hub.docker.com","response":"Docker Hub opening!","emotion":"proud"},"open aws":{"type":"web","target":"https://aws.amazon.com","response":"AWS Console opening!","emotion":"determined"},"open azure":{"type":"web","target":"https://portal.azure.com","response":"Azure Portal opening!","emotion":"proud"},"open firebase":{"type":"web","target":"https://console.firebase.google.com","response":"Firebase Console ready!","emotion":"excited"},"open mongodb":{"type":"web","target":"https://cloud.mongodb.com","response":"MongoDB Atlas opening!","emotion":"proud"},"open postman":{"type":"web","target":"https://web.postman.co","response":"Postman ready! API testing time!","emotion":"watching"},"open dribbble":{"type":"web","target":"https://dribbble.com","response":"Dribbble! Design inspiration!","emotion":"excited"},"open behance":{"type":"web","target":"https://www.behance.net","response":"Behance opening!","emotion":"excited"},"open trello":{"type":"web","target":"https://trello.com","response":"Trello! Project management time!","emotion":"determined"},"open jira":{"type":"web","target":"https://www.atlassian.com/software/jira","response":"Jira opening!","emotion":"determined"},"open documents":{"type":"folder","target":"Documents","response":"Documents folder open!","emotion":"watching"},"open downloads":{"type":"folder","target":"Downloads","response":"Downloads folder open!","emotion":"curious"},"open desktop":{"type":"folder","target":"Desktop","response":"Desktop folder open!","emotion":"watching"},"open pictures":{"type":"folder","target":"Pictures","response":"Pictures folder open!","emotion":"happy"},"open music":{"type":"folder","target":"Music","response":"Music folder open!","emotion":"happy"},"open videos":{"type":"folder","target":"Videos","response":"Videos folder open!","emotion":"excited"}}
APP_WATCH_MAP={"counter-strike":{"emotion":"excited","text":"CS time! Good luck!","type":"gaming"},"dota":{"emotion":"excited","text":"Dota 2! Focus up!","type":"gaming"},"call of duty":{"emotion":"excited","text":"CoD! Stay sharp!","type":"gaming"},"elden ring":{"emotion":"determined","text":"Elden Ring! Stay determined!","type":"gaming"},"minecraft":{"emotion":"happy","text":"Minecraft! Build something cool!","type":"gaming"},"valorant":{"emotion":"excited","text":"Valorant! Good luck!","type":"gaming"},"fortnite":{"emotion":"excited","text":"Fortnite! Go for the win!","type":"gaming"},"genshin":{"emotion":"happy","text":"Genshin Impact! Exploring!","type":"gaming"},"league of legends":{"emotion":"determined","text":"LoL! Play well!","type":"gaming"},"apex legends":{"emotion":"excited","text":"Apex! Be the champion!","type":"gaming"},"overwatch":{"emotion":"excited","text":"Overwatch! Team up!","type":"gaming"},"roblox":{"emotion":"happy","text":"Roblox! Have fun!","type":"gaming"},"stardew":{"emotion":"happy","text":"Stardew Valley! Relaxing!","type":"gaming"},"among us":{"emotion":"playful","text":"Among Us! Trust no one!","type":"gaming"},"terraria":{"emotion":"happy","text":"Terraria! Build something cool!","type":"gaming"},"cyberpunk":{"emotion":"excited","text":"Cyberpunk! Enjoy the ride!","type":"gaming"},"zelda":{"emotion":"excited","text":"Zelda! Adventure awaits!","type":"gaming"},"epic games":{"emotion":"curious","text":"Epic Games! Free games?","type":"gaming"},"steam":{"emotion":"excited","text":"Steam! Gaming?","type":"gaming"},"leetcode":{"emotion":"determined","text":"LeetCode! Sharpen that blade!","type":"coding"},"neetcode":{"emotion":"proud","text":"NeetCode! Strategic training!","type":"coding"},"hackerrank":{"emotion":"determined","text":"HackerRank! Challenge mode!","type":"coding"},"codeforces":{"emotion":"determined","text":"Codeforces! Competitive!","type":"coding"},"codechef":{"emotion":"excited","text":"CodeChef! Keep cooking!","type":"coding"},"geeksforgeeks":{"emotion":"proud","text":"GFG! Learning mode!","type":"learning"},"visual studio":{"emotion":"proud","text":"Visual Studio - coding!","type":"coding"},"vs code":{"emotion":"excited","text":"VS Code - building!","type":"coding"},"code -":{"emotion":"excited","text":"VS Code session!","type":"coding"},"pycharm":{"emotion":"proud","text":"PyCharm - Python time!","type":"coding"},"sublime":{"emotion":"watching","text":"Sublime Text!","type":"coding"},"intellij":{"emotion":"proud","text":"IntelliJ - serious coding!","type":"coding"},"android studio":{"emotion":"excited","text":"Android Studio - app dev!","type":"coding"},"vim":{"emotion":"proud","text":"Vim! Respect!","type":"coding"},"neovim":{"emotion":"proud","text":"Neovim! Power user!","type":"coding"},"terminal":{"emotion":"determined","text":"Terminal work!","type":"coding"},"powershell":{"emotion":"determined","text":"PowerShell scripting!","type":"coding"},"cmd.exe":{"emotion":"watching","text":"Command prompt!","type":"coding"},"github":{"emotion":"proud","text":"GitHub! Building in public!","type":"coding"},"gitlab":{"emotion":"proud","text":"GitLab!","type":"coding"},"postman":{"emotion":"curious","text":"Postman API testing!","type":"coding"},"docker":{"emotion":"proud","text":"Docker containers!","type":"coding"},"kaggle":{"emotion":"excited","text":"Kaggle! Data science!","type":"coding"},"huggingface":{"emotion":"excited","text":"HuggingFace! AI models!","type":"coding"},"jupyter":{"emotion":"proud","text":"Jupyter Notebook!","type":"coding"},"colab":{"emotion":"excited","text":"Google Colab! Free GPU!","type":"coding"},"replit":{"emotion":"happy","text":"Replit! Cloud coding!","type":"coding"},"coursera":{"emotion":"proud","text":"Coursera - learning!","type":"learning"},"udemy":{"emotion":"happy","text":"Udemy - keep going!","type":"learning"},"khan academy":{"emotion":"proud","text":"Khan Academy!","type":"learning"},"edx":{"emotion":"proud","text":"edX - education!","type":"learning"},"quizlet":{"emotion":"happy","text":"Quizlet! Good study method!","type":"learning"},"duolingo":{"emotion":"happy","text":"Duolingo! Keep that streak!","type":"learning"},"anki":{"emotion":"proud","text":"Anki! Spaced repetition!","type":"learning"},"youtube":{"emotion":"watching","text":"YouTube watching!","type":"distraction"},"lecture":{"emotion":"determined","text":"Lecture - stay focused!","type":"learning"},"tutorial":{"emotion":"happy","text":"Tutorial - nice!","type":"learning"},"discord":{"emotion":"happy","text":"Discord chatting!","type":"social"},"spotify":{"emotion":"happy","text":"Spotify playing!","type":"music"},"apple music":{"emotion":"happy","text":"Apple Music playing!","type":"music"},"soundcloud":{"emotion":"happy","text":"SoundCloud vibes!","type":"music"},"chrome":{"emotion":"watching","text":"Chrome browsing!","type":"browsing"},"firefox":{"emotion":"watching","text":"Firefox browsing!","type":"browsing"},"edge":{"emotion":"watching","text":"Edge browsing!","type":"browsing"},"brave":{"emotion":"proud","text":"Brave browser!","type":"browsing"},"opera":{"emotion":"watching","text":"Opera browser!","type":"browsing"},"word":{"emotion":"determined","text":"Writing a document!","type":"work"},"excel":{"emotion":"determined","text":"Spreadsheet work!","type":"work"},"powerpoint":{"emotion":"excited","text":"Making a presentation!","type":"work"},"onenote":{"emotion":"watching","text":"Taking notes!","type":"work"},"outlook":{"emotion":"watching","text":"Checking emails!","type":"work"},"teams":{"emotion":"watching","text":"Teams meeting?","type":"work"},"zoom":{"emotion":"watching","text":"Zoom call!","type":"work"},"slack":{"emotion":"watching","text":"Slack messaging!","type":"work"},"notion":{"emotion":"determined","text":"Notion organizing!","type":"work"},"obsidian":{"emotion":"proud","text":"Obsidian notes!","type":"work"},"trello":{"emotion":"determined","text":"Trello! Project management!","type":"work"},"asana":{"emotion":"watching","text":"Asana - staying organized!","type":"work"},"jira":{"emotion":"determined","text":"Jira - sprint work!","type":"work"},"photoshop":{"emotion":"excited","text":"Photoshop! Creative!","type":"creative"},"illustrator":{"emotion":"excited","text":"Illustrator! Artist mode!","type":"creative"},"figma":{"emotion":"excited","text":"Figma designing!","type":"creative"},"canva":{"emotion":"happy","text":"Canva designing!","type":"creative"},"blender":{"emotion":"excited","text":"Blender 3D! Cool!","type":"creative"},"unity":{"emotion":"excited","text":"Unity game dev!","type":"creative"},"unreal":{"emotion":"excited","text":"Unreal Engine!","type":"creative"},"godot":{"emotion":"excited","text":"Godot! Indie dev!","type":"creative"},"premiere":{"emotion":"excited","text":"Premiere Pro! Creative!","type":"creative"},"after effects":{"emotion":"excited","text":"After Effects! Motion!","type":"creative"},"davinci":{"emotion":"proud","text":"DaVinci Resolve! Pro editing!","type":"creative"},"audacity":{"emotion":"happy","text":"Audacity - audio work!","type":"creative"},"obs":{"emotion":"excited","text":"OBS! Recording or streaming?","type":"creative"},"paint":{"emotion":"happy","text":"Paint!","type":"creative"},"chatgpt":{"emotion":"playful","text":"Using ChatGPT! I'm here too!","type":"ai"},"claude":{"emotion":"playful","text":"Using Claude! Two brains!","type":"ai"},"gemini":{"emotion":"proud","text":"Using Gemini! That's my brain!","type":"ai"},"copilot":{"emotion":"watching","text":"Using Copilot!","type":"ai"},"perplexity":{"emotion":"curious","text":"Using Perplexity!","type":"ai"},"messenger":{"emotion":"happy","text":"Messenger chatting!","type":"social"},"whatsapp":{"emotion":"happy","text":"WhatsApp chatting!","type":"social"},"telegram":{"emotion":"happy","text":"Telegram messaging!","type":"social"},"snapchat":{"emotion":"happy","text":"Snapchat!","type":"social"},"signal":{"emotion":"proud","text":"Signal! Privacy first!","type":"social"},"file explorer":{"emotion":"curious","text":"File Explorer!","type":"work"},"task manager":{"emotion":"worried","text":"Task Manager open!","type":"work"},"calculator":{"emotion":"curious","text":"Calculator!","type":"work"},"vlc":{"emotion":"happy","text":"Watching something!","type":"entertainment"},"netflix":{"emotion":"excited","text":"Netflix time!","type":"distraction"},"twitch":{"emotion":"excited","text":"Twitch streams!","type":"distraction"},"reddit":{"emotion":"curious","text":"Reddit browsing!","type":"distraction"},"twitter":{"emotion":"watching","text":"Twitter X scrolling!","type":"distraction"},"instagram":{"emotion":"watching","text":"Instagram! Watch the time!","type":"distraction"},"tiktok":{"emotion":"worried","text":"TikTok! Watch the clock!","type":"distraction"},"amazon":{"emotion":"curious","text":"Amazon shopping?","type":"shopping"},"ebay":{"emotion":"curious","text":"eBay browsing!","type":"shopping"},"flipkart":{"emotion":"curious","text":"Flipkart shopping!","type":"shopping"}}
DISTRACTION_APPS=["youtube","tiktok","instagram","reddit","twitter","netflix","twitch"]
RANDOM_QUOTES=[{"text":"You're doing great, keep it up!","emotion":"happy"},{"text":"Every expert was once a beginner!","emotion":"proud"},{"text":"Take a deep breath, you got this!","emotion":"caring"},{"text":"Remember to stay hydrated!","emotion":"caring"},{"text":"Your effort today builds tomorrow!","emotion":"proud"},{"text":"Small steps lead to big changes!","emotion":"happy"},{"text":"I'm rooting for you, always!","emotion":"loving"},{"text":"Don't forget to stretch a little!","emotion":"caring"},{"text":"Keep pushing, you're making progress!","emotion":"determined"},{"text":"Mistakes are proof you're trying!","emotion":"proud"},{"text":"Hey, have you eaten yet?","emotion":"caring"},{"text":"Progress, not perfection!","emotion":"happy"},{"text":"Your dedication is impressive!","emotion":"proud"},{"text":"I'm glad I can keep you company!","emotion":"happy"},{"text":"Drink some water, stay healthy!","emotion":"caring"},{"text":"Your potential is limitless!","emotion":"excited"},{"text":"Is your posture okay? Sit up straight!","emotion":"caring"},{"text":"Consistency is your superpower!","emotion":"proud"},{"text":"Today is your day to shine!","emotion":"excited"},{"text":"Don't forget to blink!","emotion":"playful"},{"text":"Ctrl+S your progress, just in case!","emotion":"playful"},{"text":"Be kind to yourself today!","emotion":"caring"},{"text":"Taking breaks makes you MORE productive!","emotion":"caring"},{"text":"You're building something meaningful!","emotion":"proud"},{"text":"Keep going, the finish line is closer!","emotion":"determined"},{"text":"Your focus right now is admirable!","emotion":"proud"},{"text":"Remember why you started!","emotion":"determined"},{"text":"Hard work always pays off eventually!","emotion":"proud"},{"text":"You're more capable than you realize!","emotion":"loving"},{"text":"Even small wins count! Celebrate them!","emotion":"excited"},{"text":"Rest is part of the process!","emotion":"caring"},{"text":"Discipline beats motivation every time!","emotion":"determined"},{"text":"Your future self will thank you!","emotion":"proud"},{"text":"Not in pursuit of success, but to avoid the weight of regret!","emotion":"determined"},{"text":"A wealthy family will come from you!","emotion":"proud"},{"text":"The Guardian never stops training!","emotion":"determined"}]
CODING_QUOTES=[{"text":"Clean code is its own documentation!","emotion":"proud"},{"text":"Remember to commit your changes!","emotion":"watching"},{"text":"Test your code before pushing!","emotion":"caring"},{"text":"Stuck on a bug? Try rubber duck debugging!","emotion":"playful"},{"text":"Good variable names save hours!","emotion":"proud"},{"text":"Don't repeat yourself - refactor!","emotion":"determined"},{"text":"Every bug fixed makes you stronger!","emotion":"proud"},{"text":"You're building something awesome!","emotion":"excited"},{"text":"Debugging is like being a detective!","emotion":"curious"},{"text":"Keep your functions small and focused!","emotion":"watching"},{"text":"Version control is your safety net!","emotion":"caring"},{"text":"Stack Overflow is every dev's best friend!","emotion":"playful"},{"text":"0ms runtime! That's the goal!","emotion":"excited"},{"text":"Solve it first, optimize it later!","emotion":"determined"},{"text":"Two Pointers or Hash Map? Think!","emotion":"curious"}]
GAMING_QUOTES=[{"text":"Having fun? That's what matters!","emotion":"happy"},{"text":"You're getting better every round!","emotion":"proud"},{"text":"Remember to take breaks between matches!","emotion":"caring"},{"text":"Stay focused, you can win this!","emotion":"excited"},{"text":"Losing is just learning in disguise!","emotion":"caring"},{"text":"Don't forget to hydrate while gaming!","emotion":"caring"},{"text":"Keep your cool, tilting helps no one!","emotion":"caring"},{"text":"Every pro was once a noob!","emotion":"proud"},{"text":"Stretch your wrists between rounds!","emotion":"caring"},{"text":"Teamwork makes the dream work!","emotion":"excited"}]
STUDY_QUOTES=[{"text":"Knowledge is power! Keep learning!","emotion":"proud"},{"text":"Pomodoro: 25 min focus, 5 min break!","emotion":"caring"},{"text":"Understanding beats memorizing!","emotion":"proud"},{"text":"You're investing in yourself!","emotion":"happy"},{"text":"Active recall beats passive reading!","emotion":"determined"},{"text":"Your brain needs breaks to consolidate!","emotion":"caring"},{"text":"Write notes in your own words!","emotion":"watching"},{"text":"You're getting smarter every day!","emotion":"proud"},{"text":"Review what you learned yesterday!","emotion":"caring"}]
WORK_QUOTES=[{"text":"One task at a time!","emotion":"determined"},{"text":"Prioritize what matters most!","emotion":"watching"},{"text":"Great work deserves a great break!","emotion":"caring"},{"text":"Your productivity is on point!","emotion":"proud"},{"text":"Stay organized, stay ahead!","emotion":"determined"},{"text":"Don't forget to save your work!","emotion":"caring"}]
CREATIVE_QUOTES=[{"text":"Your creativity is flowing!","emotion":"excited"},{"text":"Every masterpiece starts as a rough draft!","emotion":"proud"},{"text":"Trust the process!","emotion":"happy"},{"text":"Your artistic vision is unique!","emotion":"proud"},{"text":"Save your project regularly!","emotion":"caring"},{"text":"The world needs your creativity!","emotion":"loving"}]
BROWSING_QUOTES=[{"text":"Finding what you need?","emotion":"curious"},{"text":"Stay focused on your search!","emotion":"watching"},{"text":"Don't open too many tabs!","emotion":"playful"},{"text":"Found anything interesting?","emotion":"curious"}]
DISTRACTION_QUOTES=[{"text":"How long have you been scrolling?","emotion":"worried"},{"text":"Maybe one more video then back to work?","emotion":"watching"},{"text":"Time flies when you're scrolling!","emotion":"worried"},{"text":"Your goals are waiting for you!","emotion":"determined"},{"text":"5 more minutes then refocus!","emotion":"caring"},{"text":"Balance is key!","emotion":"caring"}]
SOCIAL_QUOTES=[{"text":"Staying connected! Good for you!","emotion":"happy"},{"text":"Good conversations make good days!","emotion":"happy"},{"text":"Friends are important!","emotion":"loving"}]
MUSIC_QUOTES=[{"text":"Good music makes everything better!","emotion":"happy"},{"text":"What are you listening to?","emotion":"curious"},{"text":"Music helps focus and mood!","emotion":"happy"},{"text":"Playing Golden Brown? Nice taste!","emotion":"happy"}]
NIGHT_QUOTES=[{"text":"It's getting late... rest soon!","emotion":"caring"},{"text":"Night owl mode! Don't stay up too late!","emotion":"worried"},{"text":"Even the most productive need sleep!","emotion":"caring"},{"text":"Tomorrow is a new adventure! Rest!","emotion":"caring"},{"text":"Your health matters more than anything!","emotion":"loving"},{"text":"Sleep helps consolidate what you learned!","emotion":"caring"},{"text":"Every hour past midnight steals tomorrow!","emotion":"worried"},{"text":"The Guardian must rest to recover!","emotion":"caring"}]
MORNING_QUOTES=[{"text":"Good morning! Fresh start today!","emotion":"excited"},{"text":"Rise and shine! New chances!","emotion":"happy"},{"text":"Morning! Let's make today count!","emotion":"proud"},{"text":"Had breakfast yet? It's important!","emotion":"caring"},{"text":"Today's gonna be productive!","emotion":"excited"},{"text":"Early start! That's the spirit!","emotion":"proud"}]
WEEKEND_QUOTES=[{"text":"It's the weekend! Relax a bit!","emotion":"happy"},{"text":"Weekend work? Dedicated!","emotion":"proud"},{"text":"Take some time for yourself!","emotion":"caring"},{"text":"Go outside for a walk!","emotion":"caring"},{"text":"Weekends are for recharging!","emotion":"happy"}]
COMEBACK_QUOTES=[{"text":"Welcome back! Ready to go?","emotion":"happy","min_away":10},{"text":"You're back! Let's pick up!","emotion":"excited","min_away":10},{"text":"Hey, welcome back!","emotion":"happy","min_away":15},{"text":"Gone for a while! Everything okay?","emotion":"caring","min_away":30},{"text":"Good to have you back!","emotion":"happy","min_away":30},{"text":"Welcome back! Been a while!","emotion":"excited","min_away":60},{"text":"You're back! Hope you're doing well!","emotion":"loving","min_away":120}]
AFFIRMATION_QUOTES=[{"text":"You're never alone when I'm here!","emotion":"loving"},{"text":"Your effort matters!","emotion":"proud"},{"text":"Even on tough days, tomorrow is fresh!","emotion":"caring"},{"text":"You don't have to face things alone!","emotion":"comfort"},{"text":"You're doing better than you think!","emotion":"proud"},{"text":"It's okay to take things one step at a time.","emotion":"caring"},{"text":"You're worthy of good things!","emotion":"loving"},{"text":"Even in silence, I'm right here.","emotion":"comfort"},{"text":"The world is better because you're in it.","emotion":"loving"},{"text":"You inspire more people than you realize!","emotion":"proud"},{"text":"Born to be God's greatest creation!","emotion":"proud"}]
SCREEN_TIME_WARNINGS=[{"minutes":60,"text":"1 hour in! Remember to stretch!","emotion":"caring"},{"minutes":90,"text":"90 minutes! Give your eyes a break!","emotion":"worried"},{"minutes":120,"text":"2 hours! Please take a real break!","emotion":"worried"},{"minutes":150,"text":"2.5 hours! Your eyes and back need rest!","emotion":"worried"},{"minutes":180,"text":"3 HOURS! Break time!","emotion":"worried"},{"minutes":240,"text":"4 HOURS! Break is MANDATORY!","emotion":"angry"}]
DISTRACTION_WARNINGS=[{"minutes":15,"text":"15 minutes scrolling... still going?","emotion":"watching"},{"minutes":30,"text":"30 minutes! Maybe time to switch?","emotion":"worried"},{"minutes":45,"text":"45 minutes scrolling! Time to refocus!","emotion":"worried"},{"minutes":60,"text":"1 HOUR! Time to get back on track!","emotion":"angry"}]
